...
rem importeer de signed server certificaat in de client trust stores, en de client certificates in de server truststore
keytool -import -keystore servertruststore.p12 -file client1_cert.pem -alias client1 -storepass passwd -noprompt
keytool -import -keystore servertruststore.p12 -file client2_cert.pem -alias client2 -storepass passwd -noprompt
keytool -import -keystore client1truststore.p12 -file server_cert.pem -alias server -storepass passwd -noprompt
keytool -import -keystore client2truststore.p12 -file server_cert.pem -alias server -storepass passwd -noprompt
